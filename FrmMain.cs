...
namespace h24
{
    public partial class FrmMain : Form
    {
        ...
        public FrmMain()
        {
            ...
            apiRequestTimer = new Timer(NewCard.CheckApiRequests, null, Timeout.Infinite, Timeout.Infinite);
        ...
        //start or stop queue service
        private void cbQueueProcess_CheckedChanged(object sender, EventArgs e)
        {
            Log.Information("cbQueueProcess_CheckedChanged");
            db = new klc01();
        ...
        private void aPIRequestsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frmApiQueue f2 = new frmApiQueue();
            //f2.ShowDialog();
            f2.Show();
